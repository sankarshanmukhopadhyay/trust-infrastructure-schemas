# AIS-1 experimental profile

This profile adds a reusable **experimental** machine-readable shape for **AIS-1 bonded agent identity** inside the canonical trust artifact layer.
...
This profile is experimental. It is included so other repositories in the portfolio can reuse one normalized AIS-1 shape while the mapping is still being pressure-tested.
